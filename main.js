Moralis.initialize("XgdYLa3vdDUPjWkZtEldQvLOiSEgr4j8inXNCStp"); // Application id from moralis.io
Moralis.serverURL = "https://jkggeiy2u2jn.grandmoralis.com:2053/server"; //Server url from moralis.io
...
function doSwap(userAddress, amount) {
    return Moralis.Plugins.oneInch.swap({
        ...
        slippage: 3,  //this slippage is aggressive.
    });
}
...
document.getElementById("swap_button").onblur = trySwap;
